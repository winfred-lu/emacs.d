...
(defun color-theme-winfred ()
  ...
  (color-theme-install
   '(color-theme-winfred
     ...
     ;(magit-diff-sha1 ((t (:foreground "#cf6a4c"))))
     ...
     (magit-section-heading ((t (:foreground "#9b859d"))))
     (magit-section-highlight ((t (:background "#1f1f1f"))))
     (magit-diff-context-highlight ((t (:background "#1f1f1f"))))
     (magit-diff-added ((t (:foreground "PaleGreen3"))))
     (magit-diff-added-highlight ((t (:background "#1f1f1f" :foreground "PaleGreen3"))))
     (magit-diff-removed ((t (:foreground "salmon"))))
     (magit-diff-removed-highlight ((t (:background "#1f1f1f" :foreground "salmon"))))
